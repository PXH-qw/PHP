...
@section('title', $member->name . ' - 会员详情')
        ...
        <div class="col-md-8">
            <div class="card shadow-lg rounded-xl border-0">
                <div class="card-header bg-gradient-to-r from-green-500 to-teal-600 text-white rounded-t-xl border-0">
                    <h2 class="text-xl font-bold text-white">{{ $member->name }} 的详细信息</h2>
                </div>
                ...
                <div class="card-body p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-900">{{ $member->member_type }}</p>
                        </div>
                    ...
                    @if(auth()->user()->role === 'admin' || auth()->user()->id == $member->user_id)
                    <div class="mt-6 flex space-x-4">
                        @if(auth()->user()->role === 'admin')
                        <a href="{{ route('members.index') }}" class="text-gray-600 hover:text-gray-800 font-medium">返回会员列表</a>
                        @else
